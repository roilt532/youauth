...
_STOPWORDS_ES: frozenset[str] = frozenset({
    ...
    "es", "son", "era", "fue", "muy", "mas", "pero", "sino",
    "como", "cuando", "donde", "quien", "cual", "cuales",
    "ya", "si", "no", "ni", "o", "y", "e", "u",
    "su", "sus", "mi", "mis", "tu", "tus", "hay",
    "esto", "esta", "estos", "estas", "ese", "esa", "esos", "esas",
    "lo", "le", "les", "me", "te", "nos",
    "han", "sido", "tiene", "tienen", "hacer", "hace", "hecho",
    "ser", "estar", "tener", "puede", "pueden", "cada", "todo",
    "toda", "todos", "todas", "otro", "otra", "otros", "otras",
})

_STOPWORDS_EN: frozenset[str] = frozenset({
    "the", "a", "an", "of", "in", "to", "is", "it", "its",
    "and", "or", "but", "for", "with", "on", "at", "by",
    "this", "that", "these", "those", "what", "when", "where",
    "who", "how", "why", "can", "do", "did", "are", "was",
    "were", "be", "been", "has", "have", "had", "will", "would",
    "not", "no", "so", "if", "as", "from", "than", "then",
    "we", "you", "he", "she", "they", "our", "your", "their",
    "his", "her", "all", "each", "every", "some", "any",
    "just", "also", "more", "most", "other", "about", "after",
    "before", "while", "which", "into", "over", "such", "even",
})
...
def apply_keywords(
    ...
    marked: list[WordTiming] = [
        replace(w, is_keyword=(_clean(w.text) in keywords)) for w in words
    ]
